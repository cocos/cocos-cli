    ...
    describe('1. 基础组件操作- 添加，查询，设置属性，移除', () => {
        ...
        it('queryComponent - 查询组件', async () => {
            ...
            try {
                ...
                log(`queryComponent test error:  ${e}`);
                throw e;
            }
        });
        it('setComponentProperty - 查询组件 - string类型', async () => {
            ...
            try {
                ...
                log(`setComponentProperty test error:  ${e}`);
                throw e;
            }
        });
        ...
        it('removeComponent - 删除组件', async () => {
            ...
            try {
                ...
                log(`removeComponent test error:  ${e}`);
                throw e;
            }
        });
    });
    ...
    describe('2. 组合测试 - 添加多个不同节点', () => {
        ...
        beforeAll(async () => {
            try {
                ...
                log('组合测试 - 添加多个不同节点 - 开始');
            } catch (e) {
                log(`组合测试 - 添加多个不同节点 - 异常 : ${e}`);
                throw e;
            }
        });
        afterAll(async () => {
            try {
                ...
                log(`组合测试 - 添加多个相同节点 - 错误 ${e}`);
                throw e;
            }
            log('组合测试 - 添加多个不同节点 - 结束');
        });
    ...
    describe('3. 组合测试 - 添加多个相同节点', () => {
        ...
        beforeAll(async () => {
            try {
                ...
                log('组合测试 - 添加多个相同节点 - 开始');
            } catch (e) {
                log(`组合测试 - 添加多个相同节点 - 异常 : ${e}`);
                throw e;
            }
        });
        afterAll(async () => {
