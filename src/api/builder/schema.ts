...
export const SchemaPlatform = z.string().default('web-mobile').describe('Platform Identifier (e.g., web-desktop, web-mobile, windows, mac, ios, android, ohos etc.)'); // 平台标识符 (如: web-desktop, web-mobile, windows, mac, ios, android, ohos 等)
