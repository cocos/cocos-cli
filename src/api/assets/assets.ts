...
export class AssetsApi {
    ...
    async deleteAsset(@param(SchemaDirOrDbPath) dbPath: TDirOrDbPath): Promise<CommonResultType<TDbDirResult>> {
        ...
        try {
            await Assets.deleteAsset(dbPath);
        } catch (e) {
    ...
    async queryAssetInfo(
        ...
        try {
            ret.data = await Assets.queryAssetInfo(urlOrUUIDOrPath, dataKeys);
            if (!ret.data) {
                ret.code = COMMON_STATUS.FAIL;
    ...
    async queryAssetMeta(@param(SchemaUrlOrUUIDOrPath) urlOrUUIDOrPath: TUrlOrUUIDOrPath): Promise<CommonResultType<TAssetMetaResult>> {
        ...
        try {
            ret.data = await Assets.queryAssetMeta(urlOrUUIDOrPath);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async queryCreateMap(): Promise<CommonResultType<TCreateMapResult>> {
        ...
        try {
            ret.data = await Assets.queryCreateMap();
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async queryAssetInfos(@param(SchemaQueryAssetsOption) options?: TQueryAssetsOption): Promise<CommonResultType<TAssetInfosResult>> {
        ...
        try {
            ret.data = await Assets.queryAssetInfos(options);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async queryAssetDBInfos(): Promise<CommonResultType<TAssetDBInfosResult>> {
        ...
        try {
            ret.data = Object.values(await Assets.queryAssetDBInfos());
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async createAssetByType(
        ...
        try {
            ret.data = await Assets.createAssetByType(ccType, dirOrUrl, baseName, options);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
            console.error(e);
    ...
    async createAsset(
        ...
        try {
            ret.data = await Assets.createAsset(options);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
            console.error(e);
            ret.reason = e instanceof Error ? e.message + e.stack : String(e);
    ...
    async importAsset(
        ...
        try {
            ret.data = await Assets.importAsset(source, target, options);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async reimportAsset(@param(SchemaUrlOrUUIDOrPath) pathOrUrlOrUUID: TUrlOrUUIDOrPath): Promise<CommonResultType<TReimportResult>> {
        ...
        try {
            const assetInfo = await Assets.reimportAsset(pathOrUrlOrUUID);
            ret.data = assetInfo;
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
            console.error(e);
    ...
    async saveAsset(
        ...
        try {
            ret.data = await Assets.saveAsset(pathOrUrlOrUUID, data);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async queryUUID(@param(SchemaUrlOrPath) urlOrPath: TUrlOrPath): Promise<CommonResultType<TUUIDResult>> {
        ...
        try {
            ret.data = await Assets.queryUUID(urlOrPath);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async queryPath(@param(SchemaUrlOrUUID) urlOrUuid: TUrlOrUUID): Promise<CommonResultType<TPathResult>> {
        ...
        try {
            ret.data = await Assets.queryPath(urlOrUuid);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async queryUrl(@param(SchemaUUIDOrPath) uuidOrPath: TUUIDOrPath): Promise<CommonResultType<TUrlResult>> {
        ...
        try {
            ret.data = await Assets.queryUrl(uuidOrPath);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async queryAssetDependencies(
        ...
        try {
            ret.data = await Assets.queryAssetDependencies(uuidOrUrl, type);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async queryAssetUsers(
        ...
        try {
            ret.data = await Assets.queryAssetUsers(uuidOrUrl, type);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async querySortedPlugins(
        ...
        try {
            ret.data = await Assets.querySortedPlugins(filterOptions);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async renameAsset(
        ...
        try {
            ret.data = await Assets.renameAsset(source, target, options);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async moveAsset(
        ...
        try {
            ret.data = await Assets.moveAsset(source, target, options);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async updateDefaultUserData(
        ...
        try {
            await Assets.updateDefaultUserData(handler, path, value);
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
    ...
    async queryAssetUserDataConfig(
        ...
        try {
            const asset = await Assets.queryAsset(urlOrUuidOrPath);
            if (asset) {
                ret.data = await Assets.queryAssetUserDataConfig(urlOrUuidOrPath);
            } else {
                ret.code = COMMON_STATUS.FAIL;
    ...
    async updateAssetUserData(
        ...
        try {
            ret.data = await Assets.updateAssetUserData(urlOrUuidOrPath, path, value);
            if (!ret.data) {
                ret.code = COMMON_STATUS.FAIL;
                ret.reason = `❌Asset can not be found: ${urlOrUuidOrPath}. Please refresh asset db and try again.`;
            }
    ...
    async queryAssetConfigMap(): Promise<CommonResultType<TAssetConfigMapResult>> {
        ...
        try {
            ret.data = await Assets.queryAssetConfigMap();
        } catch (e) {
            ret.code = COMMON_STATUS.FAIL;
