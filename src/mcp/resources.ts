...
- [社区论坛](https://forum.cocos.org/)`,
     ...
     * 生成模板列表内容
     */
    private generateTemplateListContent(): string {
        const templates = {
            'resourceTemplates': [
                {
                    'type': 'typescript',
                    'name': 'TypeScript 脚本',
                    'description': '创建 TypeScript 脚本文件',
                    'extensions': ['.ts'],
                    'templates': [
                        {
                            'name': 'Component',
                ...
                },
                {
                    'type': 'javascript',
                    'name': 'JavaScript 脚本',
                    'description': '创建 JavaScript 脚本文件',
                    'extensions': ['.js'],
                    'templates': [
                        {
                            'name': 'Component',
            ...
            'buildTemplates': [
                {
                    ...
                    'name': 'Web Desktop',
                    'description': 'Web 桌面平台构建模板'
                },
                {
                    'platform': 'web-mobile',
                    'name': 'Web Mobile',
                    'description': 'Web 移动平台构建模板'
                },
                {
                    'platform': 'android',
                    'name': 'Android',
                    'description': 'Android 平台构建模板'
                },
                {
                    'platform': 'ios',
                    'name': 'iOS',
                    'description': 'iOS 平台构建模板'
                }
            ],
            'usage': {
                'createResource': '使用 cocos create-asset-by-type 命令创建资源',
                'createProject': '使用 cocos create 命令创建项目',
                'buildProject': '使用 cocos build 命令构建项目'
            }
        };
